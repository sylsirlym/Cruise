    ...
    <option value="20:00">08.00 PM</option>
      ...
      <div class="row">
        <div class="input-field col s12">
          ...
          <label for="seat">Number of Seats(1 to 5)</label>
        </div>
      </div>
      <div align="center">
...
while($rows=mysqli_fetch_array($que_vehicle))
{
	$reg=$rows['regNo'];
	        ...
	        if($seat>0&&$seat<=5){
		$book = "INSERT INTO booking (username,route,date,time,seats,vehicle ) VALUES ('$uname','$route','$date','$time','$seat','$reg')";
if (mysqli_query($conn, $book)) {
    ...
    echo "Error: " . $book . "<br>" . mysqli_error($conn);
			...
			echo '<script language=javascript>alert("Please input 1 to 5 seats")</script>';
			}
		}
