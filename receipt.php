...
<div class="content">
	...
	<div class="main">
        ...
        <h2>Oceania Cruises Booking Receipt </h2>
 ...
 <h4> Client Name: <?php echo $name;?></h4> 
  ...
  <tr>
  <td>
<h4> Travel Destination: <?php echo $route;?></h4> 
  </td>
  </tr>
  <tr>
  <td>
  <h4> Travel Date/ Time: <?php echo $date." / ".$time;?></h4>
  </td>
  </tr>
  <tr>
  <td>
  <h4> Cruise Ship Reg: <?php echo $vehicle;?></h4>
  </td>
  </tr>
  <tr>
  <td>
 <h4> Number of Seats: <?php echo $seat;?></h4>
  ...
  <a href="welcome.php"<button class="btn waves-effect waves-light" type="button" onclick="printDiv('printableArea')" >Print
