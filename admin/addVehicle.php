...
?>
      ...
      <div class="row">
        <div class="input-field col s12">
          ...
          <label for="reg">Cruise Ship Registration Number</label>
        </div>
      </div>
      <div class="row">
        <div class="input-field col s12">
...
<?php 
		...
		$sql = "INSERT INTO vehicle (regNo,route,time) VALUES ('$regNo','$route','$time')";
if (mysqli_query($conn, $sql)) {
	
		echo '<script>alert("Cruise Ship Added")</script>';
