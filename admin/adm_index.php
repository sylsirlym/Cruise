...
<head>
  <meta charset="UTF-8">
  <title>Oceania Cruises | Online Booking System</title>
...
<body background="images/banner.jpg">
 ...
 <li id="users_seller">
              <a class="waves-effect" style="text-decoration: none;" href="addVehicle.php">Add Cruise Ship</a>
            </li>
          </ul>
        </div>
      </li>
  ...
  <header>
    ...
    <nav class="indigo" role="navigation">
      <div class="nav-wrapper">
        ...
        <a data-activates="slide-out" class="button-collapse show-on-" href="#!"><marquee>Oceania Cruises: Online Reservation System</marquee></a>
  ...
  <footer class="indigo page-footer">
    <div class="container">
      <div class="row">
        <div class="col s12">
          <h5 class="white-text">Oceania Cruises</h5>
          <ul id='credits'>
            <li>
              <h6>Welcome to Oceania Cruises</h6> 
            </li>
            <li>
