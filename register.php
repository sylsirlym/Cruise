...
<head>
<title>Oceania Cruises | Online Booking System</title><meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
...
<body>
<?php include 'reHeader.php';?>
<div class="content">
	<h1>Oceania Cruises</h1>
	<div class="main">
		<h2>Register</h2>
		<div class="wrapper">
			<div id="seat-map">
  ...
  <div class="row">
    <form class="col s12" action="" method="post" name="RegisterForm" id="RegisterName">
      <div class="row">
      ...
      <div class="row">
        <div class="input-field col s12">
          <input id="last_name" type="text" class="validate" name="uname" required>
      ...
      <div class="input-field col s6">
        ...
        <div class="input-field col s6">
          <input id="password" type="password" class="validate" name="cpassword" required>
      ...
      <div align="center">
  <button class="btn waves-effect waves-light" type="submit" name="Register" id="Register">Register
    <i class="material-icons right">send</i>
  </button></div>
    </form>
  </div>
        
	<p class="copy_rights"><strong>&copy; Oceania Cruises Booking System. All Rights Reserved | Design by  Salim Tito</strong></p>
</div>
</div>
</div>
